...
static const IOTHUB_MODULE_CLIENT_LL_HANDLE TEST_IOTHUB_MODULE_CLIENT_LL_HANDLE = (IOTHUB_MODULE_CLIENT_LL_HANDLE)0x0001;
...
TEST_FUNCTION(IoTHubModuleClient_LL_Destroy_Test)
{
    ...
    //act
    IoTHubModuleClient_LL_Destroy(TEST_IOTHUB_MODULE_CLIENT_LL_HANDLE);
...
{
    //arrange
    STRICT_EXPECTED_CALL(IoTHubClientCore_LL_SetDeviceMethodCallback_Ex(TEST_IOTHUB_CLIENT_CORE_LL_HANDLE, TEST_INBOUND_DEVICE_METHOD_CALLBACK, NULL));

    //act
    IOTHUB_CLIENT_RESULT result = IoTHubModuleClient_LL_SetModuleMethodCallback(TEST_IOTHUB_MODULE_CLIENT_LL_HANDLE, TEST_INBOUND_DEVICE_METHOD_CALLBACK, NULL);
...
TEST_FUNCTION(IoTHubModuleClient_LL_DeviceMethodResponse_Test)
{
    //arrange
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubModuleClient_LL_ModuleMethodResponse(TEST_IOTHUB_MODULE_CLIENT_LL_HANDLE, TEST_METHOD_HANDLE, TEST_UNSIGNED_CHAR, TEST_SIZE_T, TEST_INT);
...
TEST_FUNCTION(IoTHubModuleClient_LL_SendEventToOutputAsync_Test)
{
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubModuleClient_LL_SendEventToOutputAsync(TEST_IOTHUB_CLIENT_CORE_LL_HANDLE, TEST_MESSAGE_HANDLE, TEST_OUTPUT_NAME, TEST_EVENT_CONFIRMATION_CALLBACK, NULL);
...
TEST_FUNCTION(IoTHubModuleClient_LL_SetInputMessageCallback_Test)
{
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubModuleClient_LL_SetInputMessageCallback(TEST_IOTHUB_CLIENT_CORE_LL_HANDLE, TEST_INPUT_NAME, TEST_MESSAGE_CALLBACK_ASYNC, NULL);
